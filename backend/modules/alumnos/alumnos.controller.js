...
const listar = async (req, res) => {
  try { 
    ...
    console.error("🔴 ERROR SQL EN LISTAR ALUMNOS:", error.message);
...
const opciones = async (req, res) => {
  try { 
    ...
    console.error("🔴 ERROR SQL EN OPCIONES:", error.message);
...
const crear = async (req, res) => {
  try { 
    ...
    console.error("🔴 ERROR SQL AL CREAR ALUMNO:", error.message);
...
const editar = async (req, res) => {
  try { 
    ...
    console.error("🔴 ERROR SQL AL EDITAR ALUMNO:", error.message);
...
const cambiarEstado = async (req, res) => {
  try { 
    ...
    console.error("🔴 ERROR SQL EN ESTADO ALUMNO:", error.message);
...
const eliminar = async (req, res) => {
  try { 
    ...
    console.error("🔴 ERROR SQL AL ELIMINAR ALUMNO:", error.message);
