...
export const getSesion          = (conductorId) => api.get(`/asistencias/sesion/${conductorId}`);
...
export const enviarUbicacion    = (viajeId, lat, lng) => api.post('/asistencias/ubicacion', { viajeId, lat, lng });
export const getUltimaUbicacion = (viajeId) => api.get(`/asistencias/ubicacion/${viajeId}`);
